...
import pestVector from "../public/images/pestVector.svg";

export default function Home() {
  return (
    <main className="content-center font-['Inter']">
      <div className="grid lg:grid-cols-2">
        <div className="img-side lg:col-span-1 hidden lg:flex mx-20 my-16 bg-rose-100 justify-center items-center rounded-2xl">
          <div className="flex justify-center px-20  ">
            <Image src={pestVector} />
          </div>
        </div>
        <div className="form-side lg:col-span-1 flex flex-col my-16 justify-center items-center">
